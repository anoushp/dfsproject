...
<tr><td></td><td><input value="Save Advert" type="submit"></td></tr>

<c:if test="${offer.id != 0}">

<tr><td></td><td>&nbsp;</td></tr>
<tr><td></td><td><input class="delete control" name="delete" id="delete" value="Delete Advert" type="submit"></td></tr>
</c:if>
</table>
</sf:form>
